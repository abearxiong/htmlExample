...
export function watch() {
  ...
  gulp.watch(paths.lib.src, gulp.series(lib, reload));
  gulp.watch(paths.styles.src, gulp.series(styles, reload));
  gulp.watch(paths.html.src, gulp.series(html, reload));
  gulp.watch(paths.components.src, gulp.series(components, reload));
...
// const build = gulp.series(clean, gulp.parallel(scripts,lib, styles, html,components, images), watch);
